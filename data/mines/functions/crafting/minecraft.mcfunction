...
execute as @e[tag=craftedmine] run scoreboard players operation @s b = @s a
...
execute as @s at @s run scoreboard players operation @p a = @s b
execute as @s run scoreboard players operation @s a -= @s b
execute as @s at @s run scoreboard players operation @e[distance=0..1,nbt={Item:{id:"minecraft:stone_pressure_plate"}},tag=craftedmine] a -= @s b
